...
public class AlignToTag extends Command {
    /**
     * A command that Aligns the Robot with an April Tag
     */

     private final int[] lineupTagsRed = {6, 7, 8, 9, 10, 11};
     private final int[] lineupTagsBlue = {17, 18, 19, 20, 21, 22};
       ...
       */
      public AlignToTag(Pose2d target, CommandSwerveDrivetrain drivetrain) {
        m_target = target;
