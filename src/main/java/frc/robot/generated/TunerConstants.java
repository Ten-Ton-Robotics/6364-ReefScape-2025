...
public class TunerConstants {
    ...
    // The type of motor used for the drive motor
    private static final SteerMotorArrangement STEER_MODE_TYPE = SteerMotorArrangement.TalonFX_Integrated;
    ...
    private static final SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> ConstantCreator =
        new SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>()
            ...
            .withSteerMotorType(STEER_MODE_TYPE)
    ...
    // Front Right
    private static final int FRONT_RIGHT_DRIVER_MOTOR_ID = 3;
    ...
    // Back Left
    private static final int BACK_LEFT_DRIVER_MOTOR_ID = 2;
    private static final int BACK_LEFT_STEER_MOTOR_ID = 0;
    private static final int BACK_LEFT_ENCODER_ID = 12;
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.430419921875);
    ...
    // Back Right
    private static final int BACK_RIGHT_DRIVER_MOTOR_ID = 4;
    ...
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontLeft =
        ConstantCreator.createModuleConstants(
            FRONT_LEFT_STEER_MOTOR_ID, FRONT_LEFT_DRIVE_MOTOR_ID, FRONT_LEFT_ENCODER_ID, kFrontLeftEncoderOffset,
            kFrontLeftXPos, kFrontLeftYPos, INVERT_LEFT_SIDE, FRONT_LEFT_STEER_MOTOR_INVERTED, FRONT_LEFT_ENCODER_INVERTED
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontRight =
        ConstantCreator.createModuleConstants(
            FRONT_RIGHT_STEER_MOTOR_ID, FRONT_RIGHT_DRIVER_MOTOR_ID, FRONT_RIGHT_ENCODER_ID, kFrontRightEncoderOffset,
            kFrontRightXPos, kFrontRightYPos, INVERT_RIGHT_SIDE, FRONT_RIGHT_STEER_MOTOR_INVERTED, FRONT_RIGHT_ENCODER_INVERTED
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackLeft =
        ConstantCreator.createModuleConstants(
            BACK_LEFT_STEER_MOTOR_ID, BACK_LEFT_DRIVER_MOTOR_ID, BACK_LEFT_ENCODER_ID, kBackLeftEncoderOffset,
            kBackLeftXPos, kBackLeftYPos, INVERT_LEFT_SIDE, BACK_LEFT_STEER_MOTOR_INVERTED, BACK_LEFT_ENCODER_INVERTED
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackRight =
        ConstantCreator.createModuleConstants(
            BACK_RIGHT_STEER_MOTOR_ID, BACK_RIGHT_DRIVER_MOTOR_ID, BACK_RIGHT_ENCODER_ID, kBackRightEncoderOffset,
            kBackRightXPos, kBackRightYPos, INVERT_RIGHT_SIDE, BACK_RIGHT_STEER_MOTOR_INVERTED, BACK_RIGHT_ENCODER_INVERTED
        );
