...
public class Constants {
    ...
    public static final double kLateralPositionD = 2;
    // angular position controller
    public static final double kAngularPositionP = 10;
    public static final double kAngularPositionD = 0;
    // velocity/acceleration constraints
    public static final double kMaxLateralSpeed = 1; // meters per second
    public static final double kMaxLateralAcceleration = 0.5; // meters per second squared
    public static final double kMaxAngularSpeed = 1 * Math.PI; // radians per second
    public static final double kMaxAngularAcceleration = 0.5 * Math.PI; // radians per second
                                                                        // squared
    // movement tolerances
