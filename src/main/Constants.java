public class Constants {
    ...
    public class PathPlanner {
        public static final PIDConstants kTranslationalPIDConstants = new PIDConstants(1.0, 0.0, 0.0);
        public static final PIDConstants kRotationalPIDConstants = new PIDConstants(1.0, 0.0, 0.0);
